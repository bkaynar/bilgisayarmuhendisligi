...
@section('title', 'Akademik Personel Düzenle')
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Yönetim Paneli</a></li>
            <li class="breadcrumb-item active" aria-current="page">Akademik Personel Düzenle</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card m-auto">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Akademik Personel Düzenle</h6>
                    <form id="personelDuzenle" method="POST" action="{{ route('akademik-guncelle', $personel->id) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="personel_isim_soyisim"
                                           id="personel_isim_soyisim" value="{{ $personel->personel_isim_soyisim }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @if($personel->personel_img)
                                        <img src="{{ asset('storage/' . $personel->personel_img) }}" alt="Personel Fotoğrafı" width="100">
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="personel_telefon"
                                           id="personel_telefon" value="{{ $personel->personel_telefon }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="tab-pane fade show active" id="tr" role="tabpanel" aria-labelledby="tr-tab">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="translations[0][personel_unvan]"
                                           id="personel_unvan_tr" value="{{ $personel->getUnvan('tr') }}" placeholder="Unvan (Türkçe)">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="translations[0][personel_gorev]"
                                           id="personel_gorev_tr" value="{{ $personel->getGorev('tr') }}" placeholder="Görev (Türkçe)">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="translations[0][personel_fakulte]"
                                           id="personel_fakulte_tr" value="{{ $personel->getFakulte('tr') }}" placeholder="Fakülte (Türkçe)">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="translations[0][personel_bolum]"
                                           id="personel_bolum_tr" value="{{ $personel->getBolum('tr') }}" placeholder="Bölüm (Türkçe)">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control tinymce-editor"
                                              ...
                                              placeholder="Personel hakkında bilgi (Türkçe)">{{ $personel->getHakkinda('tr') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="translations[1][personel_unvan]"
                                           id="personel_unvan_en" value="{{ $personel->getUnvan('en') }}" placeholder="Title (English)">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="translations[1][personel_gorev]"
                                           id="personel_gorev_en" value="{{ $personel->getGorev('en') }}" placeholder="Role (English)">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="translations[1][personel_fakulte]"
                                           id="personel_fakulte_en" value="{{ $personel->getFakulte('en') }}" placeholder="Faculty (English)">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="translations[1][personel_bolum]"
                                           id="personel_bolum_en" value="{{ $personel->getBolum('en') }}" placeholder="Department (English)">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control tinymce-editor"
                                              ...
                                              placeholder="About the staff (English)">{{ $personel->getHakkinda('en') }}</textarea>
                                </div>
                            </div>
                        </div>
...
@push('custom-scripts')
    ...
    <script>
        $(document).ready(function () {
            $('#personelDuzenle').submit(function (e) {
                e.preventDefault();
                let formData = new FormData(this);
                $.ajax({
                    url: "{{ route('akademik-guncelle', $personel->id) }}",
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
