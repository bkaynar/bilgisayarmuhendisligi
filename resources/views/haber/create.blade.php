...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card m-auto">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Haber Ekle</h6>
                    <form id="haberEkle" method="POST" action="{{ route('haber.store') }}"
                            ...
                            <div class="tab-pane fade show active" id="tr" role="tabpanel" aria-labelledby="tr-tab">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="translations[0][haber_baslik]"
                                           id="haber_baslik_tr" placeholder="Haber Başlık (Türkçe)" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control tinymce" name="translations[0][haber_icerik]"
                                              ...
                                              placeholder="Haber İçerik (Türkçe)"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="translations[1][haber_baslik]"
                                           id="haber_baslik_en" placeholder="Haber Başlık (İngilizce)" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control tinymce" name="translations[1][haber_icerik]"
                                              ...
                                              placeholder="Haber İçerik (İngilizce)"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="yayin_tarihi" id="yayin_tarihi" required>
                        </div>
                        <div class="mb-3">
                            <label for="haber_resim" class="form-label">Haber Resim</label>
                            <input type="file" class="form-control" name="haber_resim" id="haber_resim" required>
                        </div>
